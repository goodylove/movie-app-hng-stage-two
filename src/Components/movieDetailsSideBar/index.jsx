    ...
    <div className="w-[226px] border-2">
      ...
      <div className="flex ml-10 w-full ">
        <ul className="flex flex-col gap-10 w-[83%] ">
          ...
          <li className="bg-[#F8E7EB] w-[170px] h-[190px] rounded-md border-2 border-[#BE123C] flex justify-center flex-col items-center">
            <div>
